...
class _SemesterFormPageState extends State<SemesterFormPage> {
  ...
  TextEditingController remitAmountController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CommonAppBar(
        title: 'Semester Exam Registration Form',
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: [
                ...
                Text('PR Number: ${prNumberController.text}'),
                Text('Address: ${addressController.text}'),
                Text('Phone: ${phoneController.text}'),
                Text('Email: ${emailController.text}'),
                Text('Gender: $selectedGender'),
                Text('Category: $selectedCategory'),
                Text('College: $selectedCollege'),
                Text('Department: $selectedDepartment'),
                Text('Semester: $selectedSemester'),
                Text('Exam Year: ${examYearController.text}'),
                Text('Permission Month: ${permissionMonthController.text}'),
                Text('Repeater: ${isRepeater ? 'Yes' : 'No'}'),
                Text('Remit Amount: ${remitAmountController.text}'),
              ],
            ),
          ),
          actions: [
  ...
  void _initiatePayment() {
    // Implement Razorpay payment initiation logic here
    print('Initiate payment of amount: ${remitAmountController.text}');
    Razorpay razorpay = Razorpay();
    var options = {
      'key': 'rzp_live_MkhFrOg5rYD4WF',
      'amount': int.parse(remitAmountController.text) * 100, // in paise
